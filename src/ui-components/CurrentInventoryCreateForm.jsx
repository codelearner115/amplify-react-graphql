...
export default function CurrentInventoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOnHand(initialValues.onHand);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new CurrentInventory(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "CurrentInventoryCreateForm")}
    >
      <TextField
        label="Price"
        isRequired={false}
